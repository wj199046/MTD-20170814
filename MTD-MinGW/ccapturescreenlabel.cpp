...
void CCaptureScreenLabel::getPoint(QPoint &topLeftPoint, QPoint &bottomRightPoint)
{
    //获取矩形的坐标
    if(true == m_currentSelectRect.isEmpty()) return;

    topLeftPoint     = m_currentSelectRect.topLeft();
    bottomRightPoint = m_currentSelectRect.bottomRight();
}
