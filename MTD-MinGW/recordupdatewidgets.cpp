...
RecordUpdateWidgets::RecordUpdateWidgets(bool bHidden, QWidget *parent) :
    QDialog(parent),
    ui(new Ui::RecordUpdateWidgets)
{
    ...
    if(true == bHidden)
    {
        ...
        ui->gendleBox->setEnabled(false);
        ui->addressEdit->setEnabled(false);
        ui->contactEdit->setEnabled(false);
        ui->professionEdit->setEnabled(false);
        ui->personalHistoryEdit->setEnabled(false);
        ui->familyHistoryEdit->setEnabled(false);
    }
}
