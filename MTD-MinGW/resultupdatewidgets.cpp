...
ResultUpdateWidgets::ResultUpdateWidgets(bool bHidden, QWidget *parent) :
    QDialog(parent),
    ui(new Ui::ResultUpdateWidgets)
{
    ...
    if(true == bHidden)
    {
        ...
        ui->saveResultBtn->setHidden(true);
        ui->checkSpotEdit->setEnabled(false);
        ui->docIdEdit->setEnabled(false);
        ui->docNameEdit->setEnabled(false);
        ui->symptomEdit->setEnabled(false);
        ui->decisionEdit->setEnabled(false);
        ui->therapyEdit->setEnabled(false);
    }
